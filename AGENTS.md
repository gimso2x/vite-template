...
- **Runtime:** Node.js `22.22.0+` with pnpm `10.30.3+`.
...
- **Source of truth:** Local tokens in `src/styles/global.scss`
- **Tokens:** CSS Custom Properties (`var(--color-primary-500)` 등) with SCSS mappings in `src/styles/_variables.scss`.
